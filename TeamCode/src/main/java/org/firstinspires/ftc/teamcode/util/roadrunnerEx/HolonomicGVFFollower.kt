...
/**
 * Even-More-State-of-the-art path follower based on the [GuidingVectorFieldEx] with obstacle avoidance capabilities. For holonomic drives.
 *
...
class HolonomicGVFFollower @JvmOverloads constructor(
    ...
    override fun internalUpdate(currentPose: Pose2d): DriveSignal {
        ...
        val desiredHeading = gvfResult.pathPoint.heading
        ...
        val adjustedVelocity = gvfResult.vector.rotated(-currentPose.heading)
        ...
        return DriveSignal(Pose2d(velocity*adjustedVelocity.x, velocity*adjustedVelocity.y, omega))
    }
}